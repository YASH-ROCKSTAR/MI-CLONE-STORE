  ...
  return (
    <>
        <div className='PreFooter'>
            ...
            <div>{shieldIcon} <p><b>100% secure payments</b><br />We support Cards, Wallet, EMI and COD</p></div>
            <div>{mapIcon} <p><b>Vast service network</b><br /> 1000 Mi service-centers across 600 cities</p></div>
        </div>
        <div className='PreFooter2'>
            <div><p>LET'S STAY IN TOUCH</p><span>Get updates on sales sepcial and more</span></div>
            <div>
                <div>
        ...
        <div className="footer">
            ...
            <div>
                <div>Chat with our Virtaul AI Bot(24/7 Live Agent Support)</div><button>CHAT NOW</button>
            </div>
        </div>

        <div>
            <div className="footerBorder">
                <div>Copyright ©  2010 - 2021 Xiaomi. All Right Reseverd</div>
            </div>
        </div>
    </>
  )
